...
Cách dùng:
    python tach_doan_docx.py "duong_dan/kich_ban_zh.docx"          # ghi đè file đó
    python tach_doan_docx.py "a.docx" --out "a_tach.docx"          # ghi ra file mới
    python tach_doan_docx.py "a.docx" --min 1000 --max 1500
"""
